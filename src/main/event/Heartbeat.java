 ...
 * 
 * $Id: Heartbeat.java 948 2010-10-12 03:33:57Z jansen $
 */
package main.event;
...
/**
 * An event that prints out status information upon execution.
 * 
 * @author Rob Jansen
 */
public class Heartbeat extends Event {
	 ...
	 */
	public Heartbeat(long runTime) {
		super(runTime);
	}

	/**
	 * Calls the drivers status update method.
	 * 
	 * @see main.event.Event#run()
	 * @see main.system.Driver#generateStatus()
	 */
	@Override
	public void run() {
		Driver.getInstance().generateStatus(getTime());
	}
